<template>
  <div class="wg_head" style="background-color: white;">
    <!-- 控制背景颜色 -->
          ...
          <el-row type="flex" justify="end" style="margin-top:38px">
            ...
            <el-col :span="1">
              <div class="wg_search" style="cursor: pointer;margin-top: 3px" v-on:click="startsearch">
                ...
                <svg-icon icon-class="search" style="fill:balck;font-size:22px"></svg-icon>
              </div>
            </el-col>
            ...
            <el-col :span="1" style="padding-left:18px">
              <div class="wg_renzheng_icon">
                <a href="#" class="pp_icon">
                  ...
                  <svg-icon icon-class="vip" style="fill:black;font-size:24px"></svg-icon>
                </a>
              </div>
            </el-col>
