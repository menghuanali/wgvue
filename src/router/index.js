...
export const constantRouterMap = [
  ...
  {path: '/set', component: () => import('@/views/logined/user/setting'),meta: {needLogin: true}}, //需要加校检判断的路由
  {path: '/password', component: () => import('@/views/logined/user/password'),meta: {needLogin: true}}, //需要加校检判断的路由
