      ...
      <el-col :span="16">
        <el-row :gutter="30">
          <el-col :span="6" v-for="(p,index) in imgsArr" :key="index">
            <div @click.stop="showherinfo(p.id)" class="first">
            ...
            <div class="fivth">
              <el-row :gutter="5">
                <el-col :span="8">
                  <router-link class="fivth1" :to="p.workid[0]+''">
                    <img :src="p.workurl[0]+'/text_wateryin'" alt />
                  </router-link>
                </el-col>
                <el-col :span="8">
                  <router-link class="fivth1" :to="p.workid[1]+''">
                    <img :src="p.workurl[1]+'/text_wateryin'" alt />
                  </router-link>
                </el-col>
                <el-col :span="8">
                  <router-link class="fivth1" :to="p.workid[2]+''">
                    <img :src="p.workurl[2]+'/text_wateryin'" alt />
                  </router-link>
                </el-col>
              </el-row>
            </div>
            <div class="sixth">
              <span v-show="!p.isguanzhu" class="sixth1" @click.stop="FollowHer(index,p.id)">
                <i class="el-icon-plus"></i>关注
              </span>
              <span v-show="p.isguanzhu" class="sixth2" @click.stop="FollowHer(index,p.id)">
...
import { UserFans } from "@/api/allrequest.js";
      ...
      if (this.getToken) {
        ...
        UserFans(id)
          .then(response => {
            ...
            this.imgsArr[index].isguanzhu = !this.imgsArr[index].isguanzhu;
          })
          .catch(error => {});
      }
    },
